...
import { bestSeller, inStock, sort, rating ,clear} from "../../../store/filterSlice";


export const FilterBar = ({ setShow }) => {
  const sortBy = useSelector((state) => state.filterState.sortBy);
  const showBestSellerOnly = useSelector((state) => state.filterState.bestSellerOnly);
        ...
        <div className="py-4 overflow-y-auto">
          <ul className="text-slate-700 dark:text-slate-100">
            <li className="mt-1 mb-5">
              ...
              <div value={sortBy} className="flex items-center my-1">
                <input onChange={handleSortChange} checked={sortBy === 'lowToHigh'} id="price-sort-1" type="radio" value="lowToHigh" name="price-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
              ...
              <div className="flex items-center my-1">
                <input onChange={handleSortChange} checked={sortBy === 'highToLow'} id="price-sort-2" type="radio" value="highToLow" name="price-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input onChange={handleRatingFilter} checked={ratingFilter === '4STARSABOVE'} id="rating-sort-1" type="radio" value="4STARSABOVE" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                <label htmlFor="rating-sort-1" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">4 Stars & Above</label>
              </div>
              <div className="flex items-center my-1">
                <input onChange={handleRatingFilter} checked={ratingFilter === '3STARSABOVE'} id="rating-sort-2" type="radio" value="3STARSABOVE" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                <label htmlFor="rating-sort-2" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">3 Stars & Above</label>
              </div>
              <div className="flex items-center my-1">
                <input onChange={handleRatingFilter} checked={ratingFilter === '2STARSABOVE'} id="rating-sort-3" type="radio" value="2STARSABOVE" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                <label htmlFor="rating-sort-3" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">2 Stars & Above</label>
              </div>
              <div className="flex items-center my-1">
                <input onChange={handleRatingFilter} checked={ratingFilter === '1STARSABOVE'} id="rating-sort-4" type="radio" value="1STARSABOVE" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input checked={showBestSellerOnly} onChange={handleBestSellerToggle} id="best-seller" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                <label htmlFor="best-seller" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Best Seller Only</label>
              </div>
              <div className="flex items-center my-1">
                <input checked={showInStockOnly} onChange={handleInStockToggle} id="only-instock" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
